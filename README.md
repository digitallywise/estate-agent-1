<<p align="center">
  <img src="/estate-agent-1/asset/images/screenlayout.jpg" 
alt=“Luxvillas logo logo"/>
</p>


# Table of Contents :Home: <a name="Home"></a>
1. [About the project](#About the project)
2. [Features](## Features)
3. [Site Structure, mockup and colour scheme](Site Structure, mockup and colour scheme)
4. [LUXURY VILLA FOR RENT IN ADDIS ABABA](## LUXURY VILLA FOR RENT IN ADDIS ABABA)
5. [Features Left to implement](## Features Left to implement)
6. [Stake holders of the Website’s Interest](## Stake holders of the Website’s Interest)
7. [Resources used to complete the project](## Resources used to complete the project)
8. [Testing](## Testing)
...
![looks on tablet, desktop and mobile](/estate-agent-1/asset/images/screenlayout.jpg)
...
The site structure was created using ‘xmind’ mind mapping application before taking the information to Indesign to do layout mockup.
 ...
 ![Site structure](/estate-agent-1/asset/images/structure.png)
...
The mock up was done by using the Indesign grid system and using the margins, columns and gutter which concept really helped me to understand margins and paddings used in CSS. the layout of the website is based on the layout mockup, although I improved as I progressed in the project. 
 ...
 ![Layout mockup](/estate-agent-1/asset/images/mockup.jpg)
...
The colour scheme was picked from the villas gate and from the first image of the carousel. The colours I picked were not exactly pure black,  orange or maroon but I  wanted a colour that will create emotional response such as  excitement and passion and resampled to orange, black and maroon. According to the colour psychology “orange brings feelings of enthusiasm, excitement and warmth and when combined with black it’s like an illuminating spotlight in the pitch-black night. Orange is also used to draw attention in traffic lights and in advertising. Maroon is also associated with passion, love, ambition, courage, strength, warmth, and beauty.”
 ![Colour scheme](/estate-agent-1/asset/images/colour-scheme.jpg)

:Home:[ Back to Table of Contents](#home)
...
![landing page](/estate-agent-1/asset/images/home.png)
...
![landing page](/estate-agent-1/asset/images/description.png)
...
![Specification](/estate-agent-1/asset/images/spec.png)
...
![Location](/estate-agent-1/asset/images/location.png)
...
![appointment booking form](/estate-agent-1/asset/images/form.png)
...
![landing page](/estate-agent-1/asset/images/footer.png)
...
Both the villa owner’s and potential tenants’  interests being met as well as the website attracting potential tenants and leading to conversion.
:Home:[ Back to Table of Contents](#home)
...
![Navigation bar](/estate-agent-1/asset/images/navbar.png)


###### Picture slider 
The picture slider/carousel was taken from Bootstrap and modified with contents.
![original and modified forms](/estate-agent-1/asset/images/afternoonshade.jpg)
...
![original and modified forms](/estate-agent-1/asset/images/forms.png)
...
![CSS validation Result](/estate-agent-1/asset/images/css-val.png)


######  CSS
No errors were found

![HTML validation Result](/estate-agent-1/asset/images/html-val.png)
...
![accessibility test result](/estate-agent-1/asset/images/accessibility.png)
...
![Performance test result](/estate-agent-1/asset/images/performance.png)
